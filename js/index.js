...
function init() 
{
    ...
    xmlhttp.open("POST", "page/Push/data/GetCityData.php", true);
    xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
...
function loaddata(get_city)
{
	...
	xmlhttp.open("POST", "page/Push/data/GetCityDetail.php", true);
	xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
...
function post()
{
    ...
    var password2 = document.getElementById('set_password2').value;
    if (password2 == "") 
	{
		alert("請再次輸入您的密碼");
		return;
	...
	xmlhttp.open("POST", "page/Register/php/Register.php", true);
    xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
